  ...
  return (
    <>
      <Head>
        ...
        <title>Portfólio | Whiteboard</title>
      </Head>
      <div className="flex h-full w-full flex-col">
        <div className="relative flex h-[26rem] w-full items-end justify-start bg-[url('../assets/whiteboard.png')] bg-cover bg-no-repeat px-20 py-12 sm:h-80 sm:px-10 sm:py-8">
          <BannerItems />
        </div>
        <main className="mb-8 w-full px-20 py-8">
          ...
          <p className="mt-8 text-center text-2xl font-light text-black transition-colors duration-500 dark:text-textLight sm:text-base">
            Projeto que imita a interface do Figma Jam, sendo assim um
            whiteboard.
          </p>
          ...
          <div className="mt-8 flex items-center justify-center md:flex-col-reverse">
            ...
            >
              <Link
                ...
                href="https://github.com/silasfmartins/whiteboard"
                target="_blank"
              >
            ...
            >
              <Link
                className="text-2xl font-light uppercase text-white transition-colors duration-500 sm:text-[0.9rem]"
                href="https://whiteboard-ten.vercel.app/"
                target="_blank"
              >
                Ver projeto online
              </Link>
