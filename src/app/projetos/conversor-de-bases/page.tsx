  ...
  return (
    <>
      <Head>
        ...
        <title>Portfólio | Conversor de Bases</title>
      </Head>
      <div className="flex h-full w-full flex-col">
        <div className="relative flex h-[26rem] w-full items-end justify-start bg-[url('../assets/conversor-de-bases.png')] bg-cover bg-no-repeat px-20 py-12 sm:h-80 sm:px-10 sm:py-8">
          <BannerItems />
        </div>
        <main className="mb-8 w-full px-20 py-8">
          ...
          <p className="mt-8 text-center text-2xl font-light text-black transition-colors duration-500 dark:text-textLight sm:text-base">
            Esta aplicação é um conversor de bases (decimal, octal, hexadecimal
            e binário).
          </p>
          ...
          <div className="mt-8 flex items-center justify-center md:flex-col-reverse">
            ...
            >
              <a
                ...
                href="https://github.com/silasfmartins/conversor-de-bases"
                target="_blank"
                rel="noreferrer"
              >
            ...
            >
              <a
                className="text-2xl font-light uppercase text-white transition-colors duration-500 sm:text-[0.9rem]"
                href="https://conversor-de-bases-blond.vercel.app/"
                target="_blank"
                rel="noreferrer"
              >
                Ver projeto online
